...
def main():
	...
	label1 = Label(canvas, text='1) Mouse Left click to set starting and ending points', font=("Helvetica", "10"))
	label1.place(x=50, y=405)
	label2 = Label(canvas, text='2) Hold and drag with mouse right click to draw maze', font=("Helvetica", "10"))
	label2.place(x=50, y=425)

	next_button = Button(canvas, text='Next', command=lambda:start_solve(root, canvas))
